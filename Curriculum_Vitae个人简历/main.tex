...
\item[\textbf{[AS.1]}] \textbf{Wu, G.}, Liu, X., Wang, Y., \& Yang, Y. (2025). \textbf{Comprehensive evaluation and interpretative insights of peptide-HLA binding prediction tools using explainable artificial intelligence.} \textit{bioRxiv.}

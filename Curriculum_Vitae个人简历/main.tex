...
\resumeItemListStart
\item \textbf{GPA:} 3.77/4.00 (Overall); \ \ \ \ \ \textbf{RANKING :} 1st out of 22 students (Overall);\ \ \ \ \  
...
\vspace{-0.4mm}
 \resumeHeadingSkillStart
  \resumeSubItem{Programming Languages:}
    {\textbf{R, Python, html and Shell}; adaptively learning tools based on project requirements.}
  ...
  \resumeSubItem{Research Skills:}
    {Familiar with operating sysmtem (\textbf{Windows 7, 8, 10; Linux centOS, mint, ubuntu});Proficient in visualization tools including \textbf{PowerPoint, Photoshop, and Adobe Illustrator; skilled in LaTeX, Word, and Excel} for academic writing and data processing; experienced in using EndNote for reference management with \textbf{strong literature search and data organization abilities.}}
...
\vspace{-6mm}
\section{\large{\textbf{LEADERSHIP, VOLUNTEERING AND OTHER AWARDS}}}
\vspace{-0.4mm}
\resumeSubHeadingListStart
\resumeProject
